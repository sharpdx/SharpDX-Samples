namespace OfflineImageProcessingApp
{
    ...
    class Program
    {
        static void Main()
        {
            ...
            var imageParametersRef = new wic.ImageParameters(d2PixelFormat, 96, 96, 0, 0, pixelWidth, pixelHeight);
            imageEncoder.WriteFrame(d2dRenderTarget, bitmapFrameEncode, ref imageParametersRef);
